                                                                ...
                                                                <div class="mb-2">
                                                                    <div class="d-flex justify-content-between align-items-center">
                                                                        <div>
                                                                            ...
                                                                            <div class="small text-muted">{{ $session->starts_at ? $session->starts_at->format('M d, H:i') : '' }} · Room: {{ $session->room ?? '—' }}</div>
                                                                        </div>
                                                                        <div>
                                                                    ...
                                                                    <div id="collapse-session-{{ $sid }}" class="collapse mt-2">
                                                                        <div class="card card-body py-2">
                                                                            <div class="small mb-2">{{ \Illuminate\Support\Str::limit($session->description ?? '', 400) }}</div>
                                                                            <div>
                                                                                <strong>Speakers</strong>
                                                                                <ul class="list-unstyled mb-0 small">
                                                                                    @foreach($session->speakers as $speaker)
                                                                                        <li>{{ $speaker->name }} @if($speaker->pivot->role) ({{ $speaker->pivot->role }}) @endif</li>
                                                                                    @endforeach
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                            ...
                            @foreach($tracks as $tIdx => $t)
                                ...
                                <div class="track-pane @if($isFirstTrack) active @endif" data-track-id="{{ $t->id }}">
                                    ...
                                    @foreach($days as $num => $date)
                                        ...
                                        <div class="day-pane @if($loop->first) active @endif" data-day="day{{ $num }}">
                                            <div class="mb-3">
                                                <h4 class="mb-1 text-primary">{{ $t->name }} - Day {{ $num }}</h4>
                                                <p class="text-muted">{{ strtoupper($t->name) }} Day {{ $num }} Content</p>
                                            </div>
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body d-flex flex-column flex-md-row justify-content-between">
                                                                    <div class="flex-grow-1">
                                                                        ...
                                                                        <div class="mt-2">
                                                                            <strong>Speakers</strong>
                                                                            <div class="row mt-2 speakers-list">
                                                                                @foreach($session->speakers as $speaker)
                                                                                    @php
                                                                                    ...
                                                                                    <div class="col-6 col-lg-4 mb-2">
                                                                                        <div class="d-flex align-items-center gap-2">
                                                                                            <div class="rounded-circle bg-secondary text-white d-flex align-items-center justify-content-center" style="width:34px;height:34px;font-weight:600;">{{ $initials }}</div>
                                                                                            <div>
                                                                                                <div class="small fw-semibold">{{ $speaker->name }}</div>
                                                                                                @if($speaker->pivot->role)
                                                                                                    <div class="small text-muted">{{ $speaker->pivot->role }}</div>
                                                                                                @endif
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
